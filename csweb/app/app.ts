module App {
    ...
    export class AppCtrl {
        ...
        constructor(
            ...
            // var agenda = csComp.Helpers.createRightPanelTab(
            //     'agenda', 'agenda', { selectedLayerId: 'lil' }, 'Agenda', '{{"Agenda view" | translate}}', 'calendar', false, false);
            // this.$messageBusService.publish('rightpanel', 'activate', agenda);
        }
