...
declare module csComp.Services {
    ...
    class MessageBusService {
         ...
         */
        notifyWithTranslation(title: string, text: string, location?: NotifyLocation, type?: NotifyType): void;
...
declare module ButtonWidget {
    ...
    class ButtonWidgetCtrl {
        ...
        createFilter(le: csComp.Services.LegendEntry, group: string, prop: string): void;
    }
}
